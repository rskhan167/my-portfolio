    ...
    <div className={styles.timelineGrid}>
      ...
      <div className={styles.timelineGridItemCard}>
        ...
        <div className={styles.cardContent}>
          ...
          <p className={styles.cardContentDescription}>
            Modules included:
            <br />
            1st Year: Mathematical Analysis, Basic Course of C++ Programming
            Language.
            <br />
            2nd Year: Operating Systems, Computer Networks.
            <br />
            3rd Year: Advanced Course of C++ Programming Language, Using C# to
            Design Graphic Applications, The Basics of Building of Neural
            Network.
            <br />
      ...
      <div className={styles.timelineGridItemCard}>
        <div className={styles.cardContent}>
          ...
          <p className={styles.cardContentDescription}>
            Building on my own a responsive web application, which had a
            catalogue of all company's servers, displayed in the tree structure.
            Server's data was taken and parsed from XML file to JSON. Anyone
            logged could browse through lists of servers. Search and sort by
            name function were applied. App had system of accounts as well.
            Admins, technical and user ones. Admins could manage accounts by
            editing them, deleting and authorize (every new user had to be
            authorized by admin). They could also see what user is logged at the
            moment.
            <br />
            <br />
